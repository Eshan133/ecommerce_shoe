...
<body style="position: relative;background-image: url('k.jpg'); background-size: cover; background-repeat: no-repeat; background-position: center; height:100vh;">
    <div class="container" style="position: absolute; top: 0%; right: 2%; background-color: lightblue;">
        <h2>Register</h2>
            <?php
